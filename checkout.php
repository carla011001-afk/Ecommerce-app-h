...
<head>
    ...
    <title>Checkout | LGA CLOTHING</title>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href=""><i class="fa fa-phone"></i> 09063779184</a></li>
				...
				<div class="row">
					<div class="col-md-4 clearfix">
						<div class="logo pull-left">
							<a href="index.html"><img src="images/home/logo.jpeg" alt="" /></a>
						</div>
						<div class="btn-group pull-right clearfix">
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="">SOUTHERN LUZON</a></li>
									<li><a href="">VISAYA</a></li>
					...
					<tbody>
						<tr>
							<td class="cart_product">
								<a href=""><img src="images/polangui.jpeg" alts=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">LGA Design shirt POLANGUI SOLIDO</a></h4>
								<p>Web ID: 1089772</p>
							</td>
							<td class="cart_price">
								<p>500</p>
							...
							<td class="cart_total">
								<p class="cart_total_price">500</p>
							</td>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="images/spartan.jpg" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href=""> FRAT shirt SUBLIMATION SPARTAN</a></h4>
								<p>Web ID: 1089773</p>
							</td>
							<td class="cart_price">
								<p>500</p>
							...
							<td class="cart_total">
								<p class="cart_total_price">400</p>
							</td>
							<td class="cart_delete">
								<a class="cart_quantity_delete" href=""><i class="fa fa-times"></i></a>
							</td>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="images/santo.jpeg" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">LGA Design shirt SANTO ENTIERRO </a></h4>
								<p>Web ID: 1089775</p>
							</td>
							<td class="cart_price">
								<p>400</p>
